...
<template>
    <div class="comentarios my-3">
        <form class="d-flex" @submit.prevent="addNewComment" style="width:100%;">
            <input v-if="user" v-model="text" style="width: 75%;" class="mx-3" type="text" placeholder="Haz un comentario...">
            <input v-if="!user" v-model="text" readonly style="width: 75%;" class="mx-3" type="text" placeholder="Inicia sesión para comentar">
