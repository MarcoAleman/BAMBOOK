      ...
      <div class="accordion " id="accordionPanelsStayOpenExample">
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <strong>Respect the privacy of others.</strong> Instigating harassment, for example by revealing someone’s
              personal or confidential information, is not allowed. Never post or threaten to post intimate or
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseFive" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <strong>Do not post or encourage the posting of sexual or suggestive content involving minors.</strong>
            </div>
          </div>
        </div>
        <div class="accordion-item">
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseSeven" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <strong>
                Keep it legal, and avoid posting illegal content or soliciting or facilitating illegal or prohibited
                transactions.</strong>
            </div>
          </div>
        </div>
